!(function(e, t) {
  ...
  var ke = function(e, t, n) {
      t = (n ? me(e, t, n) : void 0 === t) ? 1 : Pe(Ne(t), 0)
      var r = null == e ? 0 : e.length
      if (!r || t < 1) return []
      for (var o = 0, a = 0, i = Array(xe(r / t)); o < r; )
        i[a++] = H(e, o, (o += t))
      return i
    },
    Re = c(function(e) {
  ...
  var Nt = c(function(e, t) {
    ...
    xt = l(Nt)
  Nt.on, Nt.off, Nt.filter, Nt.listen
  function Pt(e, t, n) {
    return (
      void 0 === n && (n = document),
      xt.on(n, e, t, { passive: !1 }),
      {
        remove: function() {
          xt.off(n, e, t)
        },
  ...
  ;(Vt.propTypes = {}), (Vt.defaultProps = o({}, Wt))
  ...
  ;(xn.prototype.clear = En),
    (xn.prototype.delete = On),
    (xn.prototype.get = Sn),
    (xn.prototype.has = jn),
    (xn.prototype.set = Nn)
  var Pn = xn
  ...
  var wo = function(e, t, n, r, o, a) {
    ...
    if (d && !u)
      return (
        a || (a = new Yn()),
        i || Vr(e) ? tr(e, t, n, r, o, a) : wr(e, t, l, n, r, o, a)
      )
    if (!(n & ho)) {
  ...
  var Yo = function(e, t) {
      return Er(e) ? e : xo(e, t) ? [e] : Io(qo(e))
    },
    $o = 1 / 0
  var Bo = function(e) {
  ...
  var ya = (function(e) {
      return function(t, n, r) {
        return (
          ...
          (t = Ce(t)),
          void 0 === n ? ((n = t), (t = 0)) : (n = Ce(n)),
          (r = void 0 === r ? (t < n ? 1 : -1) : Ce(r)),
          ma(t, n, r, e)
        )
      }
    })(),
          ...
          for (
            ...
            if (u) {
              ...
              if (this.canRenderSlotEvent(f, p)) {
                ...
                v && s.push(Ut(r, v, l + '_gap')),
                  s.push(Ut(r, p, l, h)),
                  (i = a = d + 1)
              } else
                v && s.push(Ut(r, v, l + '_gap')),
                  s.push(Ut(r, 1, l, this.renderShowMore(t, a))),
                  (i = a += 1)
            } else a++
          }
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              o({ isAllDay: E }, T),
              M.map(function(e, t) {
                return n.createElement(Vt, o({ key: t, segments: e }, T))
              }),
              !!D.length &&
                n.createElement(
                  wa,
        ...
        return (
          ...
          (r.renderWeek = function(e, t) {
            var o = r.props,
              ...
              y = h.rowLimit
            return (
              (a = Ca(a, e[0], e[e.length - 1], p)).sort(function(e, t) {
                return pa(e, t, p)
              }),
              n.createElement(Sa, {
                key: t,
          ...
          (r.handleHeadingClick = function(e, t, n) {
            n.preventDefault(),
              r.clearSelection(),
              x(r.props.onDrillDown, [e, t])
          }),
          (r.handleSelectEvent = function() {
            r.clearSelection()
            for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
              t[n] = arguments[n]
            x(r.props.onSelectEvent, t)
          }),
          (r.handleDoubleClickEvent = function() {
            r.clearSelection()
            for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
              t[n] = arguments[n]
            x(r.props.onDoubleClickEvent, t)
          }),
  ...
  function ka(e) {
    ...
    var m = f.length * r
    function y(e) {
      var n = W.diff(t, e, 'minutes') + xa(t, e)
      return Math.min(n, i)
    }
    return (
      f.push(
      ...
      return (
        ...
        (r.renderEvents = function() {
          ...
          return ii({
            ...
            accessors: i,
            slotMetrics: d,
            minimumStartDifference: Math.ceil((u * f) / 12),
          }).map(function(e, t) {
            var u,
              f = e.event,
              v = e.style,
    ...
    function t() {
      ...
      return (
        ((t =
          ...
          r.preventDefault(), x(t.props.onDrillDown, [e, n])
        }),
    ...
    function r(r) {
      ...
      return (
        ...
        (o.handleSelectAlldayEvent = function() {
          ...
          for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
            t[n] = arguments[n]
          x(o.props.onSelectEvent, t)
        }),
        (o.handleSelectAllDaySlot = function(e, t) {
          x(o.props.onSelectSlot, {
            slots: e,
            start: e[0],
            end: e[e.length - 1],
            action: t.action,
        ...
        return (
          ((t = e.call.apply(e, [this].concat(o)) || this).renderDay = function(
            ...
            return (r = r.filter(function(t) {
              ...
              return n.createElement(
                'tr',
                { key: o + '_' + u, className: y.className, style: y.style },
                b,
                n.createElement(
                  'td',
              ...
              if (n) {
                ...
                ;(t._widths = [
                  ...
                  (o[0] === t._widths[0] && o[1] === t._widths[1]) ||
                    ...
                    (t.refs.statusCol.style.width = t._widths[2] + 'px')),
                  r
                    ? (Ti.addClass(e, 'rbc-header-overflowing'),
                      (e.style.marginRight = pi() + 'px'))
                    : Ti.removeClass(e, 'rbc-header-overflowing')
              }
            }
          }),
          t
                    ...
                    n.createElement(
                      ...
                      n.createElement(
                        ...
                        n.createElement(
                          ...
                          n.createElement(
                            'th',
                            { className: 'rbc-header', ref: 'statusCol' },
                            s.status
                          ),
                          n.createElement(
                            'th',
  ...
  ;(ji.propTypes = {}),
    (ji.defaultProps = { length: 30 }),
    (ji.range = function(e, t) {
      var n = t.length,
        r = void 0 === n ? ji.defaultProps.length : n
      return { start: e, end: W.add(e, r, 'day') }
    }),
    (ji.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? ji.defaultProps.length : r
      switch (t) {
        case j.PREVIOUS:
  ...
  ;(Ni.propTypes = {}),
    ...
    (Ni.range = function(e, t) {
      var n = t.length,
        r = void 0 === n ? Ni.defaultProps.length : n
      return { start: e, end: W.add(e, r, 'day') }
    }),
    (Ni.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? Ni.defaultProps.length : r
      switch (t) {
        case j.PREVIOUS:
          return W.add(e, -o, 'day')
        case j.NEXT:
  ...
  var xi = (((Ci = {})[C.MONTH] = Na),
  (Ci[C.WEEK] = bi),
  (Ci[C.WORK_WEEK] = _i),
  (Ci[C.DAY] = gi),
  (Ci[C.AGENDA] = ji),
  (Ci[C.AGENDA_STATUS] = Ni),
  Ci)
  function Pi(e, t) {
    var n = t.action,
      r = t.date,
  ...
  var Fi = function(e, t, n) {
    var r = e[t]
    ;(Li.call(e, t) && U(r, n) && (void 0 !== n || t in e)) || Ai(e, t, n)
  }
  var Ii = function(e, t, n, r) {
    ...
    for (var a = -1, i = t.length; ++a < i; ) {
      ...
      void 0 === l && (l = e[s]), o ? Ai(n, s, l) : Fi(n, s, l)
    }
    return n
  }
  var zi = function(e, t) {
    return e && Ii(t, Zr(t), e)
  }
  var Wi = function(e) {
      var t = []
  ...
  var Ui = function(e) {
    ...
    var t = Br(e),
      n = []
    for (var r in e) ('constructor' != r || (!t && Hi.call(e, r))) && n.push(r)
    return n
  }
  var Vi = function(e) {
    return de(e) ? Yr(e, !0) : Ui(e)
  }
  var qi = function(e, t) {
      return e && Ii(t, Vi(t), e)
    },
    Yi = c(function(e, t) {
      var n = t && !t.nodeType && t,
        r = n && e && !e.nodeType && e,
  ...
  var Bi = function(e, t) {
    ...
    Xi = Xr(Object.getPrototypeOf, Object),
    Ki = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) _r(t, jr(e)), (e = Xi(e))
          return t
        }
      : Dr
  var Gi = function(e, t) {
  ...
  var Ns = function(e) {
      return 'function' != typeof e.constructor || Br(e) ? {} : Cs(Xi(e))
    },
    xs = '[object Map]'
  var Ps = function(e) {
      return ye(e) && vo(e) == xs
  ...
  var Ls = function(e) {
    ...
    Ys = '[object Object]',
    $s = {}
  ;($s[Us] = $s['[object Array]'] = $s['[object ArrayBuffer]'] = $s[
    '[object DataView]'
    ...
    '[object Number]'
  ] = $s[Ys] = $s['[object RegExp]'] = $s['[object Set]'] = $s[
    '[object String]'
  ] = $s['[object Symbol]'] = $s['[object Uint8Array]'] = $s[
    '[object Uint8ClampedArray]'
  ] = $s['[object Uint16Array]'] = $s['[object Uint32Array]'] = !0),
    ($s['[object Error]'] = $s[Vs] = $s['[object WeakMap]'] = !1)
  var Bs = function e(t, n, r, o, a, i) {
    var s,
      l = n & zs,
      c = n & Ws,
      u = n & Hs
    ...
    var f = Er(t)
    if (f) {
      if (((s = Qi(t)), !l)) return $i(t, s)
    } else {
      var d = vo(t),
        p = d == Vs || d == qs
      if (Fr(t)) return Yi(t, l)
      if (d == Ys || d == Us || (p && !a)) {
        if (((s = c || p ? {} : Ns(t)), !l))
          return c ? Gi(t, qi(s, t)) : Bi(t, zi(s, t))
      } else {
        if (!$s[d]) return a ? t : {}
        s = Ts(t, d, l)
      }
    ...
    var h = u ? (c ? Ji : Qr) : c ? keysIn : Zr,
      m = f ? void 0 : h(t)
    return (
      Ri(m || t, function(o, a) {
        m && (o = t[(a = o)]), Fi(s, a, e(o, n, r, a, t, i))
      }),
      s
    )
  }
  ...
  var Gs = function(e, t) {
      return (t = Yo(t, e)), null == (e = Ks(e, t)) || delete e[Bo(Xs(t))]
    },
    Js = '[object Object]',
    Zs = Function.prototype,
    Qs = Object.prototype,
    el = Zs.toString,
    tl = Qs.hasOwnProperty,
    nl = el.call(Object)
  var rl = function(e) {
    if (!ye(e) || re(e) != Js) return !1
    var t = Xi(e)
    if (null === t) return !0
    ...
    cl = ni(function(e, t) {
      ...
      for (o && me(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = Vi(a), s = -1, l = i.length; ++s < l; ) {
          var c = i[s],
            u = e[c]
          ;(void 0 === u || (U(u, sl[c]) && !ll.call(e, c))) && (e[c] = a[c])
        }
      return e
    })
  var ul = function(e, t, n) {
    ...
    if (((t = ia(t, 4)), null == n)) {
      ...
      n = o ? (r ? new a() : []) : oe(e) && ce(a) ? Cs(Xi(e)) : {}
    }
    return (
      (o ? Ri : za)(e, function(e, r, o) {
        return t(n, e, r, o)
      }),
      n
    )
      ...
      return (
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = l()
          c(
            (s = Pi(f, o({}, u, { action: e, date: n || s || d, today: d }))),
            i,
            e
          ),
        ...
        (t.handleSelectEvent = function() {
          for (var e = arguments.length, n = new Array(e), r = 0; r < e; r++)
            n[r] = arguments[r]
          x(t.props.onSelectEvent, n)
        }),
        (t.handleDoubleClickEvent = function() {
          for (var e = arguments.length, n = new Array(e), r = 0; r < e; r++)
            n[r] = arguments[r]
          x(t.props.onDoubleClickEvent, n)
        }),
        (t.handleSelectSlot = function(e) {
          x(t.props.onSelectSlot, e)
        }),
